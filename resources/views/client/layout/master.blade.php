...
<head>
    ...
    <link href="{{ asset('client_asset/lib/animate/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('client_asset/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">


    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('client_asset/css/bootstrap.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('client_asset/lib/wow/wow.min.js') }}"></script>
